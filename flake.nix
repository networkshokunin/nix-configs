{
  ...
  inputs = {
    ...
    nix-vars = {
      url = "git+ssh://git@gitlab.com/networkshokunin/nix-vars.git?ref=main&shallow=1";
      flake = false;
    };
    ...
    isc-configs = {
      url = "git+ssh://git@github.com/networkshokunin/isc-configs.git?ref=main&shallow=1";
      flake = false;
    };
  };
}